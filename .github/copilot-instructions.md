...
### Module Update Server (update.json)
...
$this->url_last_version = 'https://raw.githubusercontent.com/mokoconsulting-tech/MokoDoliTraining/main/update.json';
```

**How it works:**
1. The `auto-release.yml` workflow writes `update.json` to the repo root on every GitHub Release
2. `update.json` contains the latest version from `README.md`
...
**update.json format** (auto-generated, do not edit manually):
```json
{
  "version": "01.02.03",
  "tag": "v01.02.03",
